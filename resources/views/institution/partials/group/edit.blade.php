				  			...
				  			<div class="row">
				  				...
				  				<div class="col-md-3">
				  					<div class="form-group">
				  						...
				  						{!! Form::select('teacher_id', $teachers, (count($group->director) > 0) ? $group->director()->first()->id : null , ['class'=>'form-control chosen-select', 'placeholder'=>'Selecciones un docente']) !!}
				  					</div>
				  				</div>
				  			</div>
				  		</div>
